...
SELECT DATEADD(D,365,GETDATE()) AS DAY_365_AFTER
...
SELECT DATENAME(MONTH,'12-May-16') AS DATE_NAME,DATEPART(MONTH,'12-May-16') AS DATE_PART
--12. Write a query to find out last date of current month. 
SELECT EOMONTH(GETDATE())
--13. Calculate your age in years and months. 
SELECT DATEDIFF(YEAR,'05-05-2008',GETDATE()),DATEDIFF(MONTH,'05-05-2008',GETDATE())
