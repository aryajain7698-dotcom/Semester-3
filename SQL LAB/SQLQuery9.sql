...
SELECT DEPARTMENT,COUNT(SALARY) AS COUNT_EMP
FROM EMPLOYEE
GROUP BY DEPARTMENT
...
SELECT CITY,COUNT(SALARY) AS FEMALE_EMP
FROM EMPLOYEE
WHERE GENDER = 'FEMALE'
GROUP BY CITY
...
SELECT CITY,MAX(SALARY) AS AVG_SALARY
FROM EMPLOYEE
WHERE GENDER='FEMALE'
GROUP BY CITY
...
SELECT CITY,COUNT(SALARY) AS COUNT_EMP
FROM EMPLOYEE
...
SELECT CITY,SUM(SALARY) AS COUNT_EMP
FROM EMPLOYEE
WHERE GENDER='FEMALE'
GROUP BY CITY
HAVING SUM(SALARY)<15000
...
FROM EMPLOYEE
GROUP BY DEPARTMENT
HAVING SUM(CASE WHEN GENDER='MALE' THEN SALARY END)>SUM(CASE WHEN GENDER='FEMALE' THEN SALARY END)
